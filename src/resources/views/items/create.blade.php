...
@section('content')
    <div class="container w-50">
        <form method="POST" enctype="multipart/form-data" name="createItemForm" id="createItemForm" action="{{route('items.store')}}">
            @csrf
            <fieldset>
                ...
                <div class="row">
                    <div class="form-group col">
                        ...
                        <input type="number" min="0" max="9999999999" class="form-control @error('inputCostItem') is-invalid @enderror" id="inputCostItem" name="inputCostItem">
                ...
                <br>
                <input type="submit" name="inputCreateItem" class="btn btn-primary" value="Create item">
            </fieldset>
        </form>
    </div>
@endsection
